...
export class PlaceOrderForm extends Component<ShoppingCartProps> {
    render() {
        return (
                        ...
                        this.props.itemsList
                            ...
                            this.props.itemsList.map((item) => (
                                    <tr className="border-black  border-[0.5px]  px-1">
                                        <td className="text-[9px] border-black border-[0.5px] px-1">{item.book.code}</td>
                                        <td className="text-[9px] border-black border-[0.5px] px-1">{item.book.name}</td>
                                        <td className="text-[9px] border-black border-[0.5px] px-1">{item.book.salePrice}</td>
                                        <td className="text-[9px] border-black border-[0.5px] px-1">{item.itemCount}</td>
                                        <td className="text-[9px] border-black border-[0.5px] px-1">{(item.itemCount * item.book.salePrice)}</td>
                                    </tr>
                                ))
                    }
                </table>
